...
to adapt-threshold-value
  let normal_regret (regret / (19 * walking_cost))
  let normal_driving (time_driving / max-pxcor )
  set threshold (threshold * (normal_regret / normal_driving))
  print threshold
end
@#$#@#$#@
GRAPHICS-WINDOW
