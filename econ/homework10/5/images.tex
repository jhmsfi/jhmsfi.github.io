\batchmode
\title{Joke Propagation}
\author{Ethan Fast, Elais Jackson, Abbie Jacobs, Eric Scott}
\date{21 June, 2009}
\documentclass[12pt]{article}
\RequirePackage{ifthen}


\usepackage{floatflt,graphicx,html}
\usepackage{amsmath}
\usepackage{multicol}
...
$\displaystyle w_{ij} = w_{0ij}(1-\frac{1}{4}|\mu_i - \mu_j|),$%
...
$\displaystyle P_{activation}(J_k, n_i) = \frac{\sum_j{S_{k}(n_{ji})P_{like}(J_k,\mu_{i})}}{\sum_j{S_{k}(n_{ji})}}\frac{1}{(\sum_{j,k}{S_k(n_{ji})})^\alpha}$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
